...
import time
# ============= 网络配置 =============
# TARGET_HOST = '10.0.0.2'# '192.168.1.100' 
# FEEDBACK_HOST = '10.0.0.1' # '192.168.1.101'

# TARGET_HOST = '10.29.172.205'
# FEEDBACK_HOST = '10.29.242.65' 

TARGET_HOST = '192.168.2.101' 
FEEDBACK_HOST = '192.168.2.100'
...
# GStreamer 缓冲区设置
RECEIVER_JITTER_BUFFER_LATENCY = 300     # 抖动缓冲延迟（毫秒）
RECEIVER_DROP_ON_LATENCY = False          # 超时是否丢包
RECEIVER_APPSINK_MAX_BUFFERS = 500        # appsink 最大缓冲
